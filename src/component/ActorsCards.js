...
export default function ActorsCards(props) {
    ...
    actors = actors.filter((actor) => (actor["firstName"].toLowerCase() + " " + actor["lastName"].toLowerCase()).includes(props.filterBy) || (actor["lastName"].toLowerCase() + " " + actor["firstName"].toLowerCase()).includes(props.filterBy));
